...
# 例如：http://127.0.0.1:8788/v1 或 https://example.com/email-butler/v1
EMAIL_BUTLER_API_BASE = env_str("EMAIL_BUTLER_API_BASE", "")

# 多 API Key 客户端密钥；策略（consumer/service/cooldown/ttl）绑定在 Butler Key。
