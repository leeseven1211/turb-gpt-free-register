...
SECRET_ENV_KEYS: dict[str, str] = {
    ...
    "CLOUDFLARE_SIGNAL_API_KEY": "Cloudflare 封号邮件只读信号 API Key",
    ...
    "ICLOUD_HME_API_TOKEN": "iCloud HME 本地服务 API Token（可选）",
    "ICLOUD_HME_FORWARD_IMAP_PASSWORD": "隐藏邮箱转发目标的 IMAP 应用专用密码",
